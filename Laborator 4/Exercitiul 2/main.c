...
void start_mdns_service()
{
    ...
    //set hostname
    mdns_hostname_set("esp32-apostol");
    //set default instance
    mdns_instance_name_set("apostol");
    
    mdns_service_add(NULL, "_myservice", "_udp", 1001, NULL, 0);
}
